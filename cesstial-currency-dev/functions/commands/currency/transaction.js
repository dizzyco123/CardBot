...
// Since we used subcommands within the transactions command we they all trigger the same file.
...
await require(`../../../helper/transactionCommands/${subCommand}`)(context);